...
import { CheckCircle, ChevronDown, Route, Shield, Zap, TrendingUp, DollarSign, BarChart3, Navigation, Activity } from 'lucide-react';
                  ...
                  <div className="mt-3 sm:mt-4 space-y-1.5 sm:space-y-2">
                    ...
                    <div className="space-y-1.5 sm:space-y-2">
                      {[
                        ...
                        { icon: DollarSign, text: 'Fuel cost savings' },
                        { icon: Shield, text: 'Driver safety monitoring' },
