...
import {
  Home,
  CheckCircle2,
  Clock, Calendar, Users, BarChart2,
  ChevronDown,
  ChevronUp,
  Plus,
  Minus,
  ...
  Filter,
  Star,
 ClipboardList,CalendarDays,  LineChart,  FileText, BarChart, Smartphone,
 Check,
  X,BookOpen, PieChart,   CheckCircle, RefreshCw, GitBranch, BarChart4, Code
} from "lucide-react";
...
// };
  ...
  const contents = [
    { id: "intro", title: "Introduction to Best Project Management Software", active:"false" },
    { id: "what", title: "What Is Project Management Software?", active:"false" },
    { id: "work", title: "How Does Project Management Software Works", active:"false"  },
    { id: "approch", title: "Approach of Project Management System", active:"false" },
    { id: "features", title: "Key Features For Project Management System", active:"false"  },
    { id: "ecosystem", title: "Complete Business Software Ecosystem", active:"false"  },
  ...
  <div className="max-w-6xl mx-auto px-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
             ...
             <section id="what" className="rounded-xl max-w-6xl mx-auto p-4">
        ...
        <div className="md:flex">
          ...
          <div className="md:w-1/2 p-8 md:p-12">
            ...
            <div className="space-y-6">
              ...
              {/* How-to-choose */}
         <section id="approach" className="max-w-6xl mx-auto p-4">
    {/* agile */}
...
<section id="features" className="max-w-6xl mx-auto min-h-screen p-4">
    ...
    <section id="ecosystem" className="related-solutions max-w-6xl mx-auto p-4">
