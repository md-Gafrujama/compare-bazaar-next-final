...
const BusinessEmployeeManagement = () => {
      ...
      setTimeout(() => {
        ...
        iframeDoc.write(`
          ...
          <head>
            ...
            <title>Employee Management Software Comparison</title>
            <style>
              body {
          ...
          <body>
            <div id="bzWidgetContainer">
              <div class="loading">
                ...
                <p style="color: #000e54; font-size: 16px; font-weight: 500;">Loading employee management comparison...</p>
              </div>
            </div>
...
{/* Left side Employee Management elements */}
<div className="absolute left-0 top-0 bottom-0 w-1/4 pointer-events-none">
  ...
  <div className="absolute top-1/5 left-1/4 w-16 h-16">
    <svg className="w-full h-full animate-rotate-slow" viewBox="0 0 100 100">
      ...
      <circle cx="70" cy="30" r="5" fill="#3b82f6" />
...
<div className="absolute right-0 top-0 bottom-0 w-1/4 pointer-events-none">
  ...
  <div className="absolute bottom-1/4 right-1/4 w-16 h-16">
    <svg className="w-full h-full" viewBox="0 0 100 100">
      <rect x="10" y="10" width="35" height="35" fill="#3b82f6" opacity="0.7" />
      <rect x="55" y="10" width="35" height="35" fill="#3b82f6" opacity="0.5" />
      <rect x="10" y="55" width="35" height="35" fill="#3b82f6" opacity="0.5" />
      <rect x="55" y="55" width="35" height="35" fill="#3b82f6" opacity="0.7" />
    </svg>
  </div>
...
{/* Floating workflow visualization elements - positioned at sides */}
...
{/* Workflow path visualization - positioned at sides */}
<div className="absolute inset-0 opacity-15 pointer-events-none">
            ...
            <svg width="600" height="120" viewBox="0 0 600 120" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
              ...
              <g transform="translate(100, 30)">
                <text fontFamily="Arial" fontSize="14" fontWeight="bold" fill="#4682b4" textAnchor="middle">
                  <tspan x="30" y="10">Need Employee Management?</tspan>
                </text>
                <text fontFamily="Arial" fontSize="16" fontWeight="bold" fill="#ff7f50" textAnchor="middle">
                  <tspan x="5" y="30">Streamline your workforce!</tspan>
                </text>
                ...
                <g transform="translate(450, 20)">
                  <text fontFamily="Arial" fontSize="12" fill="#ff8633" textAnchor="left" opacity="0.8" fontWeight="bold">
                    <tspan x="-100" y="0">• Time Tracking</tspan>
                    <tspan x="-100" y="15">• Performance Management</tspan>
                    <tspan x="-100" y="30">• HR Automation</tspan>
                    <tspan x="-100" y="45">• Payroll Integration</tspan>
                  </text>
                </g>
              </g>
            </svg>
  ...
  <div className="relative backdrop-blur-xl bg-gradient-to-br from-[#000a42]/40 via-[#000e54]/40 to-[#001470]/40 rounded-2xl shadow-2xl overflow-hidden border border-[#104fff]/30">
    ...
    <div className="relative p-10 z-10 sm:h-[800px] md:h-[700px] lg:h-[680px]">
      <h2 className="text-3xl font-semibold text-white mb-4">👥 Compare Employee Management Options — 100% Free!</h2>
      <div className="w-20 h-1.5 bg-gradient-to-r from-[#104fff] to-[#3c8fff] mb-8"></div>
      <h3 className="text-xl font-semibold text-blue-100 mb-7">Looking for the best employee management solution? We've got you covered.</h3>
      ...
      <div className="mb-10 space-y-6">
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-start">
            ...
            <span className="font-medium text-blue-50 text-base">Make smarter HR decisions with side-by-side comparisons—all for $0.</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden">
    <div className="bg-gradient-to-r from-[#104fff] to-[#0026b6] p-4 text-white text-center">
      <h3 className="text-xl font-semibold">Compare Employee Solutions</h3>
    </div>
    <div 
...
export default BusinessEmployeeManagement;
